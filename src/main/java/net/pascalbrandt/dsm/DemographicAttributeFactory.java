...
public class DemographicAttributeFactory {
    ...
    static {
        ...
        DEMOGRAPHIC_CATEGORITCAL_ATTRIBUTES.put(DEMOGRAPHIC_PRETTY_ATTRIBUTE_COUNTRY_OF_ORIGIN,
                new String[] { "Kuwait", "Saint Kitts and Nevis", "Swaziland", "Belize", "Morocco",
                        "Namibia", "Romania", "Botswana", "Guinea", "Vatican City", "Lesotho",
                        "New Zealand", "Costa Rica", "Belgium", "Lebanon", "Germany", "Mongolia",
                        "Vietnam", "Montenegro", "Gambia, The", "Papua New Guinea", "Slovenia",
                        "Iraq", "Ethiopia", "Maldives", "Monaco", "Peru", "Sierra Leone",
                        "Bahrain", "Reunion", "Comoros", "Panama", "Zambia", "Nauru", "San Marino",
                        ...
                        "Antigua and Barbuda", "Moldova", "Mali", "Pakistan", "Macau", "Benin",
                        "Korea, Democratic People's Republic of (North Korea)", "Cape Verde",
                        "Congo, Democratic Republic of the (Congo - Kinshasa)", "Bulgaria",
                        "Russia", "Svalbard", "Uruguay", "Ireland", "Macedonia", "Jamaica",
                        "Colombia", "Burkina Faso", "Trinidad and Tobago", "Gabon", "Canada",
                        "Tuvalu", "Kenya", "Martinique", "Central African Republic", "Haiti",
                        "Barbados", "Indonesia", "Nepal", "Nicaragua", "Yemen", "Tristan da Cunha",
                        "Cote d'Ivoire (Ivory Coast)", "Portugal", "South Africa", "Serbia",
                        "Bosnia and Herzegovina", "United Kingdom", "France", "Chile", "Slovakia",
                        "Togo", "Tunisia", "Samoa", "Paraguay", "Zimbabwe", "Oman", "Honduras",
                        "Denmark", "Guadeloupe", "Venezuela", "Malta", "Luxembourg",
                        "Saudi Arabia", "Finland", "Turkey", "Greece", "Fiji", "Hungary",
                        "Madagascar", "Tajikistan", "Dominican Republic", "Myanmar (Burma)",
                        "Rwanda", "Guyana", "Belarus", "Seychelles", "Qatar", "Norway", "Djibouti",
                        "Liechtenstein", "Mozambique", "Sri Lanka", "Turkmenistan", "Australia",
                        "Timor-Leste (East Timor)", "Ukraine", "Somalia", "Czech Republic",
                        "Angola", "Libya", "Mexico", "Micronesia", "Ghana", "Laos", "Tanzania",
                        "Bolivia", "Georgia", "Lithuania", "Afghanistan", "Iceland", "Uganda",
                        "Latvia", "Argentina", "Grenada", "India", "Andorra", "Tonga", "Vanuatu",
                        "Uzbekistan", "Bhutan", "Spain", "Saint Lucia", "Kiribati", "Italy",
                        "Albania", "Aruba", "Malawi", "Cambodia", "Kosovo", "Singapore",
                        "Bahamas, The", "Saint Vincent and the Grenadines", "Estonia", "Aland",
                        "Iran", "Mauritius", "China, People's Republic of", "Philippines",
                        "Hong Kong", "Cyprus", "Cameroon", "Armenia", "Suriname", "Brunei",
                        "Japan", "Sao Tome and Principe", "Egypt", "Poland", "Solomon Islands",
                        "Bangladesh", "Liberia", "Eritrea", "Palau", "Switzerland", "Kyrgyzstan",
                        "Thailand", "Croatia", "Brazil", "Ascension", "Guinea-Bissau", "Ecuador" });
