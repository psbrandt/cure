        ...
        for (PatientAttributeValue pav : patientAttributes) {
            ...
            if (pav.getAttribute().getName().equals(RegaService.REGA_ATTRIBUTE_ETHNICITY)) {
                if (pav.getAttributeNominalValue().getValue().toUpperCase()
                    ...
                    fVector.setValue(getAttributes().get(ATTRIBUTE_INDEX_ETHNICITY),
                            ETHNICITY_AFRICAN);
                } else if (pav.getAttributeNominalValue().getValue().toUpperCase()
                        .equals(ETHNICITY_ASIAN.toUpperCase())) {
                    fVector.setValue(getAttributes().get(ATTRIBUTE_INDEX_ETHNICITY),
                            ETHNICITY_ASIAN);
                } else {
                    fVector.setValue(getAttributes().get(ATTRIBUTE_INDEX_ETHNICITY),
